...
const NAME_Y = 345;
// Script/cursive fonts render visually smaller than serif/sans fonts at the
// same point size — bump this up compared to what you'd use for Times/Helvetica.
...
export class CertificatesService {
  ...
  private buildPdfBuffer(recipientName: string): Promise<Buffer> {
    ...
    // Register the custom font before using it — required once per document.
    doc.registerFont(NAME_FONT_NAME, NAME_FONT_PATH);
